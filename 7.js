        ...
        songs: [
            {
                name: "Lollipop",
                positions: [
                    ["千葉恵里", "橋本陽菜", "奥本カイリ", "牧戸愛茉", "布袋百椛"],
                    ["小栗有以", "橋本恵理子", "髙橋彩音", "長友彩海"],
                    ["山内瑞葵", "花田藍衣", "徳永羚海", "大盛真歩", "下尾みう", "橋本陽菜", "倉野尾成美", "平田侑希"]
                ]
            },
            {
                name: "風の待ち伏せ",
                positions: [
                    ["秋山由奈", "正鋳真優", "畠山希美", "山根涼羽"],
                    ["水島美結", "布袋百椛", "白鳥沙怜", "田中沙友利", "新井彩永"],
                    ["佐藤綺星", "長友彩海", "久保姫菜乃"],
                    ["山﨑空", "川村結衣", "丸山ひなた", "髙橋舞桜", "正鋳真優"]
                ]
            },
            {
                name: "クリスマスリング",
                positions: [
                    ...
                    ["倉野尾成美", "田口愛佳", "正鋳真優", " 成田香姫奈", "山内瑞葵"],
                    ["鈴木くるみ", "工藤華純", "水島美結", " 渡邊葵心", "秋山由奈"],
                    ["山口結愛", "武藤小麟", "森川優"]
                ]
            },
            {
            ...
            },
            {
                name: "振り向きざまのキッス",
                positions: [
                    ["向井地美音", "太田有紀", "千葉恵里", "岩立沙穂", "鈴木くるみ", "行天優莉奈", "髙橋彩音"],
                    ["伊藤百花", "平田侑希", "大賀彩姫", "永野芹佳"],
        ...
        songs: [
            {
                ...
                id: "seifuku",
                positions: [
                    ["坂川陽香", "橋本恵理子", "橋本陽菜", "川村結衣", "秋山由奈", "徳永羚海", "近藤沙樹", "黒須遥香", "千葉恵里"],
                    ["大盛真歩", "込山榛香", "髙橋彩音", "倉野尾成美", "長友彩海", "村山彩希", "花田藍衣", "山﨑空", "工藤華純", "山内瑞葵", "山口結愛", "橋本陽菜"],
            ...
            },
            {
                ...
                id: "kiseki",
                positions: [
                    ["岩立沙穂", "太田有紀", "永野芹佳", "鈴木くるみ", "長友彩海", "成田香姫奈", "畠山希美"],
            ...
            },
            {
                ...
                id: "gyakuten",
                positions: [
                    ["武藤小麟", "布袋百椛", "倉野尾成美", "八木愛月", "橋本陽菜", "福岡聖菜", "近藤沙樹", "水島美結", "行天優莉奈"],

                    // 👉 制服レジスタンス ポジ2
                    "ref:seifuku:1",

                    ["長友彩海", "橋本陽菜", "向井地美音", "佐藤綺星", "迫由芽実", "徳永羚海", "山根涼羽"]
                ]
            },
            {
                name: "明日のためにキスを",
